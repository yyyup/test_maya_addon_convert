...
.. code-block:: python
    ...
    from zoo.libs.maya.cmds.lighting.directionaltypes import arnolddirectional
...
class ArnoldDirectional(directionalbase.DirectionalBase):
    ...
    def create(self, message=True):
        ...
        # Add Zoo renderer tag, differentiates between VRay/Arnold/Maya, attr name is "zooRendererTracker" str renderer
